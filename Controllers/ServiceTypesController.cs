...
namespace Marofh.Controllers
{
    ...
    public class ServiceTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,NameAR,NameEN")] ServiceType serviceType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,NameAR,NameEN")] ServiceType serviceType)
        {
            if (ModelState.IsValid)
            {
