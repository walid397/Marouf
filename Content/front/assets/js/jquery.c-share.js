...
(function (global, factory) {
    ...
    if ($.fn) {
        ...
        $.fn.cShare = function (options) {
                ...
                data: {
                    fb: {
                        ...
                        href: function href(url, description) {
                            return 'https://www.facebook.com/sharer.php?u=' + url + '&quote=' + description ;
                        },
                        show: true
                    },
                    gPlus: {
            ...
            this.find('[data-icon=line] .fa-stack-1x').css('color', '#32afed');
            ...
            this.find('[data-icon=weibo] .fa-stack-2x').css('color', '#29c44d');
